...
######################            UCI data           ##################
data = np.genfromtxt(r'C:\Users\Kook\Desktop\SVM_Uncertain_2\data\sonar.dat',
                      skip_header= 65,
                      skip_footer=0,
                      names=None,
                      dtype=float,
...
_params = [{'C': [0.001, 0.01, 0.1, 1, 10,100],
   'tau': [0.2, 0.4, 0.8, 1],
   # 'tau_1': [0.2, 0.4, 0.8, 1],
   # 'tau_2': [0.2, 0.4, 0.8,1], 
...
#using_model = SVM_Hinge_sgd_3(max_epochs = 50, n_batches = 32)
using_model = SVM_Insensitive_BFGS_2(max_epochs = 5, n_batches = 64)
#using_model = SVM_GP_sgd_2(max_epochs = 3, n_batches = 32)

#using_model = RBF_SVM_Hinge_sgd_2(max_epochs = 10, n_batches = 64)
#using_model = RBF_SVM_Insensitive_BFGS_2(max_epochs = 50, n_batches = 64, C=0.125, tau =2  , epsilon = 0.4)
#using_model = RBF_SVM_GP_sgd_2(max_epochs = 3 , n_batches = 64)
